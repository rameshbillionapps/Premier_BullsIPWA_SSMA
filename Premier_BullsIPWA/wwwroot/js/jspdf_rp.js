		...
		output: function(type, options) {
			...
			if(type == 'datauri') {
				...
				if (browser == "Microsoft Internet Explorer"){
					...
					myActiveXObject.CreateTextFile(TEMP + "\\test.pdf");
					file = myActiveXObject.GetFile(TEMP + "\\test.pdf");
					text = file.OpenAsTextStream(ForWriting, TristateFalse);
					text.write(buffer);
					//text.Write("<html><body><object width=\"100%\" height=\"100%\" TYPE=\"application/pdf\" DATA=\"data:application/pdf;base64,\" > </object></body></html>");
					text.Close();
					window.open(TEMP + "\\test.pdf");
				}
				else{
					window.open('data:application/pdf;base64,' + Base64.encode(buffer));
				}
